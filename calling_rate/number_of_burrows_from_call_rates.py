...
def _get_number_of_burrows_in_burrow_area(burrow_geci_data_path, burrow_jm_data_path):
    ...
    return XX_get_number_of_burrows_in_burrow_area(burrow_geci_data, burrow_jm_data)


def XX_get_number_of_burrows_in_burrow_area(burrow_geci_data, burrow_jm_data):

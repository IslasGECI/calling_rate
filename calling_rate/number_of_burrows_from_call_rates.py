...
def get_call_rate_in_burrow_area(recorder_data):
    ...
    return XXget_call_rate_in_burrow_area(recorder_data, burrow_geci_data, burrow_jm_data)


def XXget_call_rate_in_burrow_area(recorder_data, burrow_geci_data, burrow_jm_data):
...
def get_density_in_recorder_area(paths):
    ...
    return (
        ...
        * get_call_rate_in_recorder_area(recorded_data)
        / XXget_call_rate_in_burrow_area(recorded_data, burrow_geci_data, burrow_jm_data)
    )

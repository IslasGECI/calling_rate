...
def xxget_density_in_recorder_area(recorder_data_path, burrow_geci_data_path, burrow_jm_data_path):
    return (
        get_density_in_burrow_area(burrow_geci_data_path, burrow_jm_data_path)
